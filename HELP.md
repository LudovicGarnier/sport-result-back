...
* The original package name 'com.sportresult.app-back' is invalid and this project uses 'com.sportresult.app_back' instead.
...
```
$ docker run --rm -p 8080:8080 app-back:0.0.1-SNAPSHOT
```
